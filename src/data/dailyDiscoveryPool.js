 ...
 *   situations that didn't fit the main 18-question quiz but generate
...
const BONUS_QUESTIONS = [
  ...
  { id: 101, category: 'communication', framework: 'Conflict',
    ...
    options: [
      ...
      "Join them for 20 min, a quick break won't hurt",
    ] },
  { id: 102, category: 'nervous', framework: 'Sensory',
    text: 'Your ideal apartment temperature setting is:',
    options: [
      'Cool: 65 to 68°F, I sleep better cold',
      'Mild: 69 to 71°F, a comfortable middle',
      'Warm: 72 to 74°F, I get cold easily',
  ...
  { id: 111, category: 'emotional', framework: 'Conflict',
    ...
    options: [
      ...
      'Different every time, it depends on the fight',
    ] },
...
const REFLECTIONS = [
  ...
  },
  {
    ...
    generate: (p) => ({
      ...
      body: `Your answers cluster around anxious attachment: you notice when something feels off, and you want to resolve it before it grows. That instinct is genuinely useful in cohabitation; the average roommate conflict festers for 6 to 8 days before either party brings it up, and you'd raise it in 1 or 2. The trade-off: a roommate who runs avoidant will read your need-to-resolve as pressure. A 24-hour "let it sit and see" rule before raising small things usually feels intolerable but works.`,
    }),
  },
  {
  ...
  },
  {
    ...
    generate: (p) => ({
      ...
      body: `Your HEXACO Honesty-Humility answers land in the top quartile: you'd replace a borrowed product, you ask before using shared things, you wouldn't take credit for a roommate's idea. That trait is the single strongest empirical predictor of cohabitation harmony, full stop. The roommate failure mode you'll experience: living with someone who runs lower on this axis will burn out your goodwill faster than other personality mismatches. Your matching algorithm weight on this dimension is intentionally high, so pay attention to the honesty-humility readout on any potential roommate's profile.`,
    }),
  },
  {

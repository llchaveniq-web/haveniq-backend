...
// route in the app (matches.js's openers/explain). Walks the real Express
// router's internal stack rather than firing 40+ requests to trip the
// limiter — this fails immediately if a future refactor drops the
// middleware from the route, which a behavioral test would only catch
// after re-sending dozens of requests.

...
//   - requires a real top band AND a real reference (lowest) band with data,
...
// or { ok:false }.
function publicHeadline({ totalSample, bands } = {}, { minSample = PUBLIC_MIN_SAMPLE } = {}) {
  ...
  if (top.sampleSize < 1 || reference.sampleSize < 1) return { ok: false };
...
module.exports = { PUBLIC_MIN_SAMPLE, brierScore, auc, isMonotonic, publicHeadline };
